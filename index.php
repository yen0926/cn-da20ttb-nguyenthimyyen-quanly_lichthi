...
<body>
    ...
    <div class="container">
        <div class="row my-5">
            <div class="col-md-4">
                <img height="350px" src="<?=URL_ROOT?>/assets/img/home/ktcn.jpeg" alt="">
            </div>
            <div class="col-md-8">
                ...
                <p class="text-justify">Với sự phát triển của kỹ thuật hiện đại, Kỹ thụât và Công nghệ đóng một vai trò rất quan trọng trong phát triển công nghiệp, Khoa Kỹ thuật và Công nghệ (KT&CN) được thành lập theo quyết định số: 179/QĐ-ĐHTV ngày
                    20/10/2006 của Hiệu
                    trưởng trường Đại học Trà Vinh với 5 đơn vị: Bộ môn Công nghệ Thông tin, bộ môn Điện - Điện tử, bộ môn Cơ khí - Động lực, bộ môn Xây dựng và Văn phòng Khoa. Hiện tại, đội ngũ của Khoa có 80 viên chức, tất cả họ đều trẻ, năng động và
                    ham học hỏi. Vì thế, Khoa tạo nhiều cơ hội để họ được bồi dưỡng và nâng cao nghề nghiệp. Hằng năm, Khoa tuyển mới trên 500 sinh viên. Đặc biệt, số lượng sinh viên tìm được việc làm sau 1 năm tốt nghiệp là 90%.</p>
                <p class="text-justify">Khoa KT&CN đã vạch ra chiến lược phát triển đội ngũ giảng dạy, cải tiến theo quy trình làm việc ISO 9001:2015 của Trường. Khoa cũng cập nhật các chương trình đào tạo đáp ứng nhu cầu thực tiễn, đặc biệt là đào tạo
                    HTDN (Co-op) theo mô
                    hình Win – Win – Win (Sinh viên – Nhà trường – Doanh nghiệp) và định hướng tiến tới đào tạo theo chuẩn AUN, ABET.
                </p>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row py-5">
                <div class="col-md-12 p-3">
                    <div class="text-center text-white"><h3>TIN TỨC</h3></div>
                </div>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p>
                                <span><i class="far fa-eye mr-2"></i> 126</span>
                                <span><i class="fas fa-calendar-alt mx-2"></i> 1 tháng trước</span>
                            </p>
                            <div class="text-center">
                                <a href="#" class="btn btn-outline-primary">Xem thêm</a>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        <img src="https://ktcn.tvu.edu.vn/ht96_image/news/yoB0_z4186974858221_92804f76777bde341f5fb4bc42ffac68.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h6 class="card-title">Chia sẻ kinh nghiệm thiết kế thiết bị tăng sóng hiện đại phổ biến BLE (bluetooth low energy) </h6>
                            <p>
                                <span><i class="far fa-eye mr-2"></i> 163</span>
                                <span><i class="fas fa-calendar-alt mx-2"></i> 2 tháng trước</span>
                            </p>
                            <div class="text-center">
                                <a href="#" class="btn btn-outline-primary">Xem thêm</a>
                            </div>
