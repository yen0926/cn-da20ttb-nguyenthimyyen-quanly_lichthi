                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <!-- Admin role -->
                                            <?php if ($_SESSION['LoaiTaiKhoan'] == 'admin' && $d['Duyet'] == '1') {?>
                                            <a class="btn btn-warning mt-2" href="<?=URL_ROOT?>/admin/exam-schedule/edit.php?id=<?=$d['MaLT']?>"><i class="fa fa-edit"></i></a>
                                            <a class="btn btn-danger mt-2" href="?del-id=<?=$d['MaLT']?>"><i class="fa fa-trash"></i></a>
                                            <?php }?>

                                            <!-- Teacher role -->
                                            <?php if ($_SESSION['LoaiTaiKhoan'] == 'teacher' && $d['Duyet'] == '0') {?>
                                            <!-- <a class="btn btn-warning mt-2" href="<?=URL_ROOT?>/admin/exam-schedule/edit.php?id=<?=$d['MaLT']?>"><i class="fa fa-edit"></i></a> -->
                                            <a class="btn btn-danger mt-2" href="?del-id=<?=$d['MaLT']?>"><i class="fa fa-trash"></i></a>
                                            <?php }?>
                                            <?php if ($_SESSION['LoaiTaiKhoan'] == 'teacher' && $d['Duyet'] == '2') {?>
                                            <!-- <a class="btn btn-warning mt-2" href="<?=URL_ROOT?>/admin/exam-schedule/edit.php?id=<?=$d['MaLT']?>"><i class="fa fa-edit"></i></a> -->
                                            <a class="btn btn-danger mt-2" href="?del-id=<?=$d['MaLT']?>"><i class="fa fa-trash"></i></a>
                                            <?php }?>
                                        </td>
