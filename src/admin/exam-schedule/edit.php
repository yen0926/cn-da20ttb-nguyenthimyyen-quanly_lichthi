...
<?php
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ExamScheduleDB::UpdateExamSchedule($_POST['MaLT'], $_POST['TenLT'], $_POST['NgayBD'], $_POST['TGThi'], $_POST['TietDB'], $_POST['PhongThi'], $_POST['MaHT'], $_POST['MaNH'], $_POST['MaHK'], $_POST['MaMH'], $_POST['MaGV'], $_SESSION['LoaiTaiKhoan'] == 'teacher' ? $_SESSION['MaGV'] : $_POST['MaLop'], $_POST['LanThi']);
